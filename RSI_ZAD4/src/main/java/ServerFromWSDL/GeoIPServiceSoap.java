...
public interface GeoIPServiceSoap {
    ...
    @RequestWrapper(localName = "GetIpLocation", targetNamespace = "http://lavasoft.com/", className = "ServerFromWSDL.GetIpLocation")
    @ResponseWrapper(localName = "GetIpLocationResponse", targetNamespace = "http://lavasoft.com/", className = "ServerFromWSDL.GetIpLocationResponse")
    ...
    @RequestWrapper(localName = "GetIpLocation_2_0", targetNamespace = "http://lavasoft.com/", className = "ServerFromWSDL.GetIpLocation20")
    @ResponseWrapper(localName = "GetIpLocation_2_0Response", targetNamespace = "http://lavasoft.com/", className = "ServerFromWSDL.GetIpLocation20Response")
    ...
    @RequestWrapper(localName = "GetLocation", targetNamespace = "http://lavasoft.com/", className = "ServerFromWSDL.GetLocation")
    @ResponseWrapper(localName = "GetLocationResponse", targetNamespace = "http://lavasoft.com/", className = "ServerFromWSDL.GetLocationResponse")
    ...
    @RequestWrapper(localName = "GetCountryISO2ByName", targetNamespace = "http://lavasoft.com/", className = "ServerFromWSDL.GetCountryISO2ByName")
    @ResponseWrapper(localName = "GetCountryISO2ByNameResponse", targetNamespace = "http://lavasoft.com/", className = "ServerFromWSDL.GetCountryISO2ByNameResponse")
    ...
    @RequestWrapper(localName = "GetCountryNameByISO2", targetNamespace = "http://lavasoft.com/", className = "ServerFromWSDL.GetCountryNameByISO2")
    @ResponseWrapper(localName = "GetCountryNameByISO2Response", targetNamespace = "http://lavasoft.com/", className = "ServerFromWSDL.GetCountryNameByISO2Response")
