 ...
 * generated in the ServerFromWSDL package. 
...
public class ObjectFactory {
    ...
    private final static QName _Echo_QNAME = new QName("http://server.com/", "echo");
    private final static QName _DownloadImage_QNAME = new QName("http://server.com/", "downloadImage");
    private final static QName _EchoResponse_QNAME = new QName("http://server.com/", "echoResponse");
    private final static QName _DownloadImageResponse_QNAME = new QName("http://server.com/", "downloadImageResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ServerFromWSDL
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.com/", name = "echo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.com/", name = "downloadImage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.com/", name = "echoResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.com/", name = "downloadImageResponse")
