...
//        Remote lookup = Naming.lookup("//192.168.0.106:1099/calculatorRegistry");
        ...
        IServerPeopleList myServer = (IServerPeopleList) lookup;
        ...
        while (true) {
            ...
            switch (option) {
                case "0":
                    Collection<ClientPerson> allPeople = myServer.getAll();
                    StringBuilder sb = new StringBuilder();
                    for (ClientPerson prsn : allPeople) {
                ...
                case "1":
                    ...
                    ClientPerson foundPerson = myServer.getPerson(requestName);
