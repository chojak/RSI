 ...
 * generated in the soap.Client1.GeneratedByWsimport package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://Server.soap/", "getHelloWorldAsString");
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://Server.soap/", "getHelloWorldAsStringResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: soap.Client1.GeneratedByWsimport
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Server.soap/", name = "getHelloWorldAsString")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://Server.soap/", name = "getHelloWorldAsStringResponse")
