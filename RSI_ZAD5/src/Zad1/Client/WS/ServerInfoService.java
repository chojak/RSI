...
@WebServiceClient(name = "ServerInfoService", 
		targetNamespace = "http://WS.ServerSide.Zad1/", 
    ...
    extends Service
{
    ...
    public ServerInfoService() {
        super(SERVERINFOSERVICE_WSDL_LOCATION, new QName("http://WS.ServerSide.Zad1/", "ServerInfoService"));
    }
    ...
    public ServerInfo getServerInfoPort() {
        return (ServerInfo)super.getPort(new QName("http://WS.ServerSide.Zad1/", "ServerInfoPort"), ServerInfo.class);
    }
    ...
    public ServerInfo getServerInfoPort(WebServiceFeature... features) {
        return (ServerInfo)super.getPort(new QName("http://WS.ServerSide.Zad1/", "ServerInfoPort"), ServerInfo.class, features);
    }
