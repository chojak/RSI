...
public class ObjectFactory {
    ...
    private final static QName _GetServerName_QNAME = new QName("http://WS.ServerSide.Zad1/", "getServerName");
    private final static QName _GetServerNameResponse_QNAME = new QName("http://WS.ServerSide.Zad1/", "getServerNameResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WS.ServerSide.Zad1/", name = "getServerName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WS.ServerSide.Zad1/", name = "getServerNameResponse")
