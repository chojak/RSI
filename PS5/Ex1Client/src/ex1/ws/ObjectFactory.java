 ...
 * generated in the ex1.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetServerName_QNAME = new QName("http://WS.SOAPHandler.Zad1/", "getServerName");
    private final static QName _GetServerNameResponse_QNAME = new QName("http://WS.SOAPHandler.Zad1/", "getServerNameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ex1.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WS.SOAPHandler.Zad1/", name = "getServerName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WS.SOAPHandler.Zad1/", name = "getServerNameResponse")
