 ...
 * 
 */
@WebServiceClient(name = "ServerInfoService", targetNamespace = "http://WS.SOAPHandler.Zad1/", wsdlLocation = "http://localhost:8888/ws/server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERINFOSERVICE_QNAME = new QName("http://WS.SOAPHandler.Zad1/", "ServerInfoService");
    ...
    public ServerInfo getServerInfoPort() {
        return super.getPort(new QName("http://WS.SOAPHandler.Zad1/", "ServerInfoPort"), ServerInfo.class);
    }
    ...
    public ServerInfo getServerInfoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WS.SOAPHandler.Zad1/", "ServerInfoPort"), ServerInfo.class, features);
    }
